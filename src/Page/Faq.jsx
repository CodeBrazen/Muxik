      ...
      <div className=" text-white ">
        ...
        <div className=" rounded-lg mt-7">
          ...
          >
            <div className="px-5 py-4 bg-[#1b103f] rounded-b-lg ">
                Frontend : <br />
                <a href="https://github.com/CodeBrazen/Muxik" target="_blank" className=" border-b-2 text-blue-300 max-w-xs break-words">https://github.com/CodeBrazen/Muxik</a>
                <br />
                Backend:
                <br />
                <a href="https://github.com/CodeBrazen/Muxik-backend" target="_blank" className=" border-b-2 text-blue-300 break-words">https://github.com/CodeBrazen/Muxik-backend</a> 
                <br />
              </div>
          </TECollapse>
        </div>
